...
/**
 * Final Decoding is an implementation of a SuperCipher to demonstrate its functionality.
 */
...
public class FinalDecoding {
    public static void main(String[] args) {
        ...
        BaseCipher[] cipherChain = {
                new WordReplacementCipher("world", "neighborhood"), new WordReplacementCipher("enigma device", "grill"),
